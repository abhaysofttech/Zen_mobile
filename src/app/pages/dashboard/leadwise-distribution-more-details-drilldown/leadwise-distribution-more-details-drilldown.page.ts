...
@Component({
  selector: 'app-leadwise-distribution-more-details-drilldown',
  templateUrl: './leadwise-distribution-more-details-drilldown.page.html',
  styleUrls: ['./leadwise-distribution-more-details-drilldown.page.scss'],
})
export class LeadwiseDistributionMoreDetailsDrilldownPage implements OnInit {
