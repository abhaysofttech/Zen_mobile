...
@Component({
  selector: 'app-twenty-five-window-with-weightage-more-details',
  templateUrl: './twenty-five-window-with-weightage-more-details.page.html',
  styleUrls: ['./twenty-five-window-with-weightage-more-details.page.scss'],
})
export class TwentyFiveWindowWithWeightageMoreDetailsPage implements OnInit {
  ...
  constructor(
    ...
    this.storage.get('empNumber').then((data) => {
      ...
      // Api call to get with weightage more details data
      this.getWithWeightageMoreDetailsData();
    })
  }
  ...
  // Below method used to get data for with weightage more details
  getWithWeightageMoreDetailsData() {
    ...
    if (this.platform.is('cordova')) {
      ...
      if (this.network.checkNetWorkConnection()) {
        ...
        this.api.twentyFiveWindowWithWeightageMoreDetails(this.authToken, this.empNumber, this.role)
          .then((response: any) => {
            // Dismiss the loader
            this.dismissLoader();

            let withWeightageMoreDetailsData = JSON.parse(response.data);
            console.log('With Weightage more details data -> ', withWeightageMoreDetailsData)
  ...
  associateStaffNumberClick(data: any) {
    ...
    this.navCtrl.push('twenty-five-window-with-weightage-more-details-drilldown',
      {
