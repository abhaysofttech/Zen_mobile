...
@Component({
  selector: 'app-twenty-five-window-with-weightage-more-details-drilldown',
  templateUrl: './twenty-five-window-with-weightage-more-details-drilldown.page.html',
  styleUrls: ['./twenty-five-window-with-weightage-more-details-drilldown.page.scss'],
})
export class TwentyFiveWindowWithWeightageMoreDetailsDrilldownPage implements OnInit {
