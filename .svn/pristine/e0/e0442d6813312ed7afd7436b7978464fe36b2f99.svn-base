...
@Component({
  selector: 'app-overall-associates-more-details-drilldown',
  templateUrl: './overall-associates-more-details-drilldown.page.html',
  styleUrls: ['./overall-associates-more-details-drilldown.page.scss'],
})
export class OverallAssociatesMoreDetailsDrilldownPage implements OnInit {
